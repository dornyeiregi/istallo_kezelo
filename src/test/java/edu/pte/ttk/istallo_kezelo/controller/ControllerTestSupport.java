...
final class ControllerTestSupport {
    ...
    static User user(Long id, String username, String lastName, String firstName) {
        User user = new User();
        user.setId(id);
    ...
    static FeedSchedItem feedSchedItem(FeedSched feedSched, Item item, double amount) {
        FeedSchedItem feedSchedItem = new FeedSchedItem();
        feedSchedItem.setFeedSched(feedSched);
        feedSchedItem.setItem(item);
        feedSchedItem.setAmount(amount);
        return feedSchedItem;
    }

    static HorseFeedSched horseFeedSched(Horse horse, FeedSched feedSched) {
    ...
    static HorseShot horseShot(Horse horse, Shot shot) {
    ...
    static HorseTreatment horseTreatment(Horse horse, Treatment treatment) {
    ...
    static HorseFarrierApp horseFarrierApp(Horse horse, FarrierApp farrierApp) {
